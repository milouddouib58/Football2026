...
# --- ✅ THE FIX: ADD THIS BLOCK AT THE VERY TOP ---
# This adds your project's root directory to Python's path,
# allowing it to find the 'common' folder and its modules.
...
# Now the imports from 'common' will work correctly
