...
def run_feature_generator():
    """
    الدالة الرئيسية لتحميل البيانات وإنشاء ملف ميزات لنموذج تعلم الآلة.
    """
    ...
    # --- 2. المرور على جميع المباريات لإنشاء الميزات ---
    for match in all_matches:
        ...
        # استخراج معرّفات الموسم والفريق
        ...
        # تجميع كل الميزات في قاموس واحد
        features = {
            "match_id": match["id"],
            "date": dt.isoformat(),
            "home_team_id": h_id,
    ...
    # --- 3. إنشاء DataFrame وحفظه في ملف CSV ---
    if not feature_list:
