...
def run_pipeline(years_to_fetch: int):
        ...
        for year in target_years:
            ...
            if matches_in_year:
                ...
                for match in matches_in_year:
                    if match and isinstance(match, dict) and 'id' in match:
    ...
    try:
        with open(matches_path, 'w', encoding='utf-8') as f:
            json.dump(list(all_matches.values()), f, ensure_ascii=False, indent=2, sort_keys=True)
    ...
    if teams_data:
        ...
        try:
            with open(teams_path, 'w', encoding='utf-8') as f:
                json.dump(teams_data, f, ensure_ascii=False, indent=2, sort_keys=True)
